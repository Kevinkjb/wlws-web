  ...
  return (
    <div>
      <div className="advertisement-container">
        ...
        <p className="advertisement-text advertisement-info">Date: June 19-21, 2026</p>
        <p className="advertisement-text advertisement-info">Location: 50th Ave, Wetaskiwin, Alberta</p>
        <p className="advertisement-text advertisement-info">Time: 11AM - 7PM (FRI & SUN), 10AM - 7PM (SAT)</p>
