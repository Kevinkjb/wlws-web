...
const DropDown = () => {
  return (
    <DropdownButton id="dropdown-basic-button" title="Join Us" className="toggle"  variant="none">
      ...
      <Dropdown.Item className='drop-item' href="https://docs.google.com/forms/d/1PUZAmU1e2APvbI0e0bKFvZwDUUih9on4ix9wsdum3qk/viewform?edit_requested=true" target='_blank'>Sponsorship</Dropdown.Item>
    </DropdownButton>
  )
}
